...
if(stayAlive == "y" || stayAlive == "yes") {
  ...
  let decisonAfter = READLINE.question("Will you go to Costco and take what ever tools and food you find(1) or will you go to the gun shop and take what ever weapons you find?");
    if (decisionAfter == 1) {
    console.log("There is no one at Costco, but you did find food and tools.");
    }
  else if (decisonAfter == 2){
